...
const figures$h = process.platform === 'win32' ? win$1 : main$2;
...
const readline$1 = require$$0__default["default"];

const _require$9 = util$1,
      action$2 = _require$9.action;

const EventEmitter$1 = require$$2__default["default"];
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        try {
          ...
          answer = prompt$2._injected ? getInjectedAnswer$1(prompt$2._injected, question.initial) : yield prompts$4[type](question);
...
var lib = Object.assign(prompt, { prompt, prompts: prompts$2, inject, override });
...
const fs = require$$2__default$1["default"];
